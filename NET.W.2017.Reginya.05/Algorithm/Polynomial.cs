...
{    
    ...
    public sealed class Polynomial
    {
        ...
        /// </exception>
        public static Polynomial operator -(Polynomial lhs, Polynomial rhs) => Subtract(lhs, rhs);
        ...
        /// </exception>
        public static Polynomial operator *(Polynomial polynomial, double multiplier) => Multiply(polynomial, multiplier);
        ...
        /// Throws if polynomial is null
        /// </exception>
        public static Polynomial operator *(double multiplier, Polynomial polynomial) => Multiply(polynomial, multiplier);
        ...
        /// </exception>
        public static Polynomial operator /(Polynomial polynomial, double divider) => Divide(polynomial, divider);
        ...
        /// Throws if polynomial is null
        /// </exception>
        public static Polynomial Negate(Polynomial polynomial) => Multiply(polynomial, -1d);
        ...
        /// Throws if polynomial is null
        /// </exception>
        public static Polynomial Multiply(double multiplier, Polynomial polynomial) => Multiply(polynomial, multiplier);
